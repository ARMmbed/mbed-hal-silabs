...
void spi_enable_pins(spi_t *obj, uint8_t enable, PinName mosi, PinName miso, PinName clk)
{
    if (enable) {
        /* Master mode */
...
void spi_format(spi_t *obj, int bits, int mode, spi_bitorder_t order)
{
    ...
    usart_init(obj, 100000, databits, true, clockMode);
