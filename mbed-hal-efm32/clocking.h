...
#    define HFRCO_FREQUENCY         CMU_HFRCOCTRL_BAND_1MHZ
...
#    define HFRCO_FREQUENCY         CMU_HFRCOCTRL_BAND_11MHZ
...
#    define HFRCO_FREQUENCY         CMU_HFRCOCTRL_BAND_21MHZ
#  elif (YOTTA_CFG_HARDWARE_CLOCK_CORE_FREQUENCY == 28000000)
#    define HFRCO_FREQUENCY         CMU_HFRCOCTRL_BAND_28MHZ
#  else
#    error "Invalid HFRCO frequency, check your config.json"
#  endif
