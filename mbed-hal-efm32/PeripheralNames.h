...
typedef enum {
    ...
    SLIDER_1 = LESENSE_CHANNEL_11,
    SLIDER_2 = LESENSE_CHANNEL_10,
    SLIDER_3 = LESENSE_CHANNEL_9,
    SLIDER_4 = LESENSE_CHANNEL_8,
} LESENSEName;

#define LESENSE_CHANNEL_TOTAL   16
#define LESENSE_CHANNEL_IN_USE  4
#define SLIDER_MAX              4

#define LESENSE_SENSITIVITY_PERCENT 90

/* GPIO Port for analog comparators */
#define LESENSE_CH_PORT gpioPortC

#define LESENSE_IFS_ALL_CHANNELS 0x0000FFFF
#endif // DEVICE_LESENSE
